...
<body>
                        ...
                        <div class="modal-content">
                                ...
                                <form action="#" method="POST" id="add_employee_form" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body p-4 bg-light">
                                                ...
                                                <div class="my-2">
                                                        <label for="text">othername</label>
                                                        <input type="text" name="student_other_name" class="form-control" placeholder="E-mail" required>
                                                </div>
                                                <div class="my-2">
                                                        <label for="phone">Phone</label>
                                                        <input type="tel" name="student_phone" class="form-control" placeholder="" required>
                                                </div>
                                                <div class="my-2">
                                                        <label for="post">Email</label>
                                                        <input type="text" name="student_email" class="form-control" placeholder="Student email" required>
                                                </div>
                                        </div>
                                        <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" id="add_employee_btn" class="btn btn-primary">Add new students</button>
                                        </div>
                                </form>
                        </div>
                </div>
        </div>
        {{-- add new students modal end --}}

        {{-- edit students modal start --}}
        <div class="modal fade" id="editEmployeeModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
                <div class="">
                        <div class="modal-content">
                                <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">EditStudent</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
