      ...
      <div class="col-md-8 offset-md-2">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <p>Please select "Other" if your college is not listed below </p>
              </div>
    ...
    @if ($errors->has('student_first_name'))
      ...
      <span class="text-danger">{{ $errors->first('student_last_name') }}</span>
           @endif
                  ...
                  <div class="col-md-12">
                    <input type="number" name="institution_id" class="form-control" placeholder="Your institution id" required>
                  </div>
