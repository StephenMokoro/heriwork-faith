    ...
    <div class="container col-lg-7  ">
        ...
        <div class="  border  pb-5 pt-5  rounded-5">
            ...
            <div class="text-center mt-2">
                <form action="">
                    <button type="submit" class="btn btn-lg btn-secondary rounded-pill " id="button1" disabled>Create Account</button>
                </form>
            </div>
            <div class="text-center mt-4"> 
                <p class="text-black">Don't have an Account ? <a href="#">Sign Up</a> </p>
              </div>
        </div>
