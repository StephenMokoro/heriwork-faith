                    ...
                    <div class="card-body pt-4 pl-0 pr-0 pb-5 ml-0 mr-0 mt-4 mb-0">
                        <div class="row">
                            <div class="col-lg-12 pl-5 pr-5 mb-3">
                                ...
                                <p class="card-text line-">This will help us match you to talent within your range. We encourage our impact employers to be considerate and propose budgets that serve to uplift underprivileged students. </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 pl-0 pr-0 mb-5">
                ...
                <form action="{{ route('internship.create.step.five.post') }}" method="POST">
                    ...
                    <div class="col-lg-12 text-end" style=" bottom:0">
                        ...
                        <button type="submit" class="btn rounded-pill btn-success">Next:Review details</button>
