        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 d-flex flex-column justify-content-center">
              ...
              <h2 class="custom-line-height1" data-aos="fade-up" data-aos-delay="400">We collaborate to expand paid temporary workstudy jobs and internship opportunities for underprivileged college students to generate some income for upkeep and fees.</h2>
              ...
              <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                <div class="content">
                  ...
                  <h4 class="custom-line-height1">
                    We are an impact startup working with individual and institutional well-wishers to extend paid temporary jobs and internship opportunities to underprivileged college students to help them raise income for their upkeep and/or fees.
                  </h4>
        ...
        <section id="services" class="services">
          ...
          <div class="container" data-aos="fade-up">
            ...
            <header class="section-header mb-5">
              ...
              <h1 class="text-black text-center mb-3"><b>Engage our students</b></h1>
              <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-8">
                  <h4 class="text-black float-left">Our impact employers have engaged our students in varying tasks depending on their needs. See examples below to get you started.</h4>
                </div>
                <div class="col-lg-2"></div>
              </div>
            </header>
