            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="student_first_name" value="{{ $student->student_first_name}}" class="form-control"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="email" name="student_email" class="form-control" placeholder="Company Email"
